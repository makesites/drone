	...
	ssl : function(){ 
		...
		for(var host in config.ssl){ 
			...
			if( typeof site.credentials != "undefined" || typeof site.domain != "undefined"){ 
				...
				//router[site.domain] = "127.0.0.1:"+config.ports.proxy;
				router[site.domain] = "127.0.0.1:"+80;
				creds[site.domain] = credentials({key:key, cert:cert});
